...
if(file_exists('../private-config-bd.php'))  // fichier de configuration "privé" (enseignants)
	...
	define('UTILISATRICE', 'p2101340'); // votre login, par exemple p1234567
	define('MOTDEPASSE', 'Stench52Alarm'); // votre mot de passe, par exemple Abcd12Efgh
	define('BDD', 'p2101340'); // votre BD, par exemple p1234567	
}
?>
